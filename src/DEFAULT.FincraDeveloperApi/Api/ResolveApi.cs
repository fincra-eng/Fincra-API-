...
namespace DEFAULT.FincraDeveloperApi.Api
{
    ...
    /// </summary>
    public interface IResolveApi : IApiAccessor
    {
        ...
        ApiResponse<Object> ResolveBankAccountWithHttpInfo ();
        ...
        System.Threading.Tasks.Task ResolveBankAccountAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ResolveBankAccountAsyncWithHttpInfo ();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ResolveApi : IResolveApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ResolveApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Resolve Bank Account This endpoint resolves bank account information based the account number and bank code provided. This is only valid for Nigerian bank accounts
        /// </summary>
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns></returns>
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> ResolveBankAccountWithHttpInfo ()
        {

            var localVarPath = "/resolve";
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling ResolveBankAccount: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling ResolveBankAccount: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ResolveBankAccountAsync ()
        {
             await ResolveBankAccountAsyncWithHttpInfo();
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ResolveBankAccountAsyncWithHttpInfo ()
        {
