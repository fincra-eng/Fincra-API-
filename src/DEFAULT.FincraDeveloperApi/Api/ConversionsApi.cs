...
namespace DEFAULT.FincraDeveloperApi.Api
{
    ...
    /// </summary>
    public interface IConversionsApi : IApiAccessor
    {
        ...
        /// <param name="conversionId">The ID of the conversion</param>
        /// <returns></returns>
        ...
        ApiResponse<Object> GetaconversionWithHttpInfo (string conversionId);
        /// <summary>
        /// Get all conversions
        /// </summary>
        /// <remarks>
        ...
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> GetallconversionsWithHttpInfo (string businessId);
        /// <summary>
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> InitiateaconversionWithHttpInfo ();
        ...
        System.Threading.Tasks.Task GetaconversionAsync (string conversionId);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetaconversionAsyncWithHttpInfo (string conversionId);
        /// <summary>
        /// Get all conversions
        /// </summary>
        /// <remarks>
        ...
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task GetallconversionsAsync (string businessId);
        ...
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> GetallconversionsAsyncWithHttpInfo (string businessId);
        /// <summary>
        /// Initiate a conversion
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task InitiateaconversionAsync ();
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> InitiateaconversionAsyncWithHttpInfo ();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ConversionsApi : IConversionsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ConversionsApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Get a conversion This endpoint fetches a specific conversion performed by a business. 
        /// </summary>
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="conversionId">The ID of the conversion</param>
        /// <returns></returns>
        public void Getaconversion (string conversionId)
        {
        ...
        /// <param name="conversionId">The ID of the conversion</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetaconversionWithHttpInfo (string conversionId)
        {
            // verify the required parameter 'conversionId' is set
            if (conversionId == null)
                throw new ApiException(400, "Missing required parameter 'conversionId' when calling ConversionsApi->Getaconversion");

            var localVarPath = "/conversions/{conversionId}";
            ...
            if (conversionId != null) localVarPathParams.Add("conversionId", Configuration.ApiClient.ParameterToString(conversionId)); // path parameter
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling Getaconversion: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling Getaconversion: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="conversionId">The ID of the conversion</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetaconversionAsync (string conversionId)
        {
             await GetaconversionAsyncWithHttpInfo(conversionId);
        ...
        /// <param name="conversionId">The ID of the conversion</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetaconversionAsyncWithHttpInfo (string conversionId)
        {
            // verify the required parameter 'conversionId' is set
            if (conversionId == null)
                throw new ApiException(400, "Missing required parameter 'conversionId' when calling ConversionsApi->Getaconversion");
        ...
        /// <summary>
        /// Get all conversions This endpoint provides a list of all conversions performed by a business. 
        /// </summary>
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns></returns>
        public void Getallconversions (string businessId)
        {
        ...
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetallconversionsWithHttpInfo (string businessId)
        {
            // verify the required parameter 'businessId' is set
            if (businessId == null)
                throw new ApiException(400, "Missing required parameter 'businessId' when calling ConversionsApi->Getallconversions");

            var localVarPath = "/conversions/business/{businessId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling Getallconversions: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling Getallconversions: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetallconversionsAsync (string businessId)
        {
             await GetallconversionsAsyncWithHttpInfo(businessId);
        ...
        /// <param name="businessId">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetallconversionsAsyncWithHttpInfo (string businessId)
        {
            // verify the required parameter 'businessId' is set
            if (businessId == null)
                throw new ApiException(400, "Missing required parameter 'businessId' when calling ConversionsApi->Getallconversions");
        ...
        /// <summary>
        /// Initiate a conversion This endpoint provides information on the conversion rate between two currencies e.g NGN to USD     REQUEST BODY   | Field | Data Type | Description | |------| ------------- | ----------- | | business | string | This could be the ID of the business or the ID of a sub-account of the businessRequired | | quoteReference | string | To get a quote reference, you will need to call the generate quote endpoint Required |  
        /// </summary>
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns></returns>
        public void Initiateaconversion ()
        {
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> InitiateaconversionWithHttpInfo ()
        {

            var localVarPath = "/conversions/initiate";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling Initiateaconversion: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling Initiateaconversion: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task InitiateaconversionAsync ()
        {
             await InitiateaconversionAsyncWithHttpInfo();
        ...
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> InitiateaconversionAsyncWithHttpInfo ()
        {
