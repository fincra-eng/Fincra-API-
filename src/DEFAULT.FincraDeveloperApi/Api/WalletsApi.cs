...
namespace DEFAULT.FincraDeveloperApi.Api
{
    ...
    public interface IWalletsApi : IApiAccessor
    {
        ...
        ApiResponse<Object> GetallthewalletsforaBusinessWithHttpInfo (string businessID);
        /// <summary>
        /// Get a wallet
        /// </summary>
        /// <remarks>
        ...
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> GetawalletWithHttpInfo (string walletID);
        ...
        System.Threading.Tasks.Task GetallthewalletsforaBusinessAsync (string businessID);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetallthewalletsforaBusinessAsyncWithHttpInfo (string businessID);
        /// <summary>
        /// Get a wallet
        /// </summary>
        /// <remarks>
        ...
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task GetawalletAsync (string walletID);
        ...
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> GetawalletAsyncWithHttpInfo (string walletID);
    ...
    public partial class WalletsApi : IWalletsApi
    {
        ...
        /// <summary>
        /// Get all the wallets for a Business This endpoints lists all wallets belonging to a business.
        /// </summary>
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="businessID">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns></returns>
        public void GetallthewalletsforaBusiness (string businessID)
        {
        ...
        /// <param name="businessID">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetallthewalletsforaBusinessWithHttpInfo (string businessID)
        {
            // verify the required parameter 'businessID' is set
            if (businessID == null)
                throw new ApiException(400, "Missing required parameter 'businessID' when calling WalletsApi->GetallthewalletsforaBusiness");
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetallthewalletsforaBusiness: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling GetallthewalletsforaBusiness: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="businessID">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetallthewalletsforaBusinessAsync (string businessID)
        {
             await GetallthewalletsforaBusinessAsyncWithHttpInfo(businessID);
        ...
        /// <param name="businessID">This could be the ID of the business or the ID of a sub-account of the business</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetallthewalletsforaBusinessAsyncWithHttpInfo (string businessID)
        {
            // verify the required parameter 'businessID' is set
            if (businessID == null)
                throw new ApiException(400, "Missing required parameter 'businessID' when calling WalletsApi->GetallthewalletsforaBusiness");
        ...
        /// <summary>
        /// Get a wallet This endpoint provides the information regarding a specific wallet.
        /// </summary>
        /// <exception cref="DEFAULT.FincraDeveloperApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns></returns>
        public void Getawallet (string walletID)
        {
        ...
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetawalletWithHttpInfo (string walletID)
        {
            // verify the required parameter 'walletID' is set
            if (walletID == null)
                throw new ApiException(400, "Missing required parameter 'walletID' when calling WalletsApi->Getawallet");
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling Getawallet: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling Getawallet: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetawalletAsync (string walletID)
        {
             await GetawalletAsyncWithHttpInfo(walletID);
        ...
        /// <param name="walletID">The ID of the wallet</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetawalletAsyncWithHttpInfo (string walletID)
        {
            // verify the required parameter 'walletID' is set
            if (walletID == null)
                throw new ApiException(400, "Missing required parameter 'walletID' when calling WalletsApi->Getawallet");
