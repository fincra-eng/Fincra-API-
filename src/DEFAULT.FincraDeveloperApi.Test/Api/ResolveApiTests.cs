...
namespace DEFAULT.FincraDeveloperApi.Test
{
    ...
    /// </remarks>
    [TestFixture]
    public class ResolveApiTests
    {
        private ResolveApi instance;
        ...
        /// <summary>
        /// Test an instance of ResolveApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            Assert.IsInstanceOf<ResolveApi> (instance, "instance is a ResolveApi");
        }

        
        /// <summary>
        /// Test ResolveBankAccount
        /// </summary>
        [Test]
        public void ResolveBankAccountTest()
        {
            // TODO: add unit test for the method 'ResolveBankAccount'
            instance.ResolveBankAccount();
